export const PROFILE_NAME = 'Jorge Rama Krsna Mandoju';
...
export const PROFILE_DESCRIPTION =
	'Desenvolvedor Full stack, especialista em Frontend e Mobile.';
export const PROFILE_LINKEDIN =
	'https://www.linkedin.com/in/jorge-rama-krsna-mandoju-29805797/';
export const PROFILE_GITHUB = 'https://github.com/mandoju';

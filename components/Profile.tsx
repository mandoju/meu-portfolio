...
const Profile = () => {
    return (<section className="relative py-16 bg-gray-300">
                    ...
                    <div className="flex flex-wrap justify-center">
                        <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                            <div className="relative">
                                <img
                                    alt="Profile picture"
                                    src={"https://media-exp1.licdn.com/dms/image/C4D03AQG_8RiqS3iEvw/profile-displayphoto-shrink_400_400/0/1560905090794?e=1633564800&v=beta&t=KIo2JW55r19GQji7mASe521ArZF65aGuyAj_S_ArPEo"}
